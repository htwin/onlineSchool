	...
	private void prepareCourseNews(List<MsgNews> msgNews, String contextUri){
		...
		for(Course c : list){
			...
			if(StringUtils.isNotEmpty(c.getPicture())){
				...
				//news.setPicpath("http://img01.taopic.com/141128/240418-14112P9345826.jpg");
				news.setPicpath("http://pq3g44sos.bkt.clouddn.com/@/default/all/0/e00c78c25d724cee92c7ccdb22d59cb0.png?e=1556192432&token=vAB0m5fgWj5rV7RWjbzAqEC8NMy8HtT7WmTT19JI:LIK9Kh_jbPglwn4XuYsnY23sT00=");
			}
