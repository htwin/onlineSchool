...
public class CourseServiceImpl implements ICourseService{
	...
	private void prepareCoursePicture(Course course){
		if(null != course && StringUtils.isNotEmpty(course.getPicture())){
			...
			String defaultImg = "http://pq3g44sos.bkt.clouddn.com/@/default/all/0/e00c78c25d724cee92c7ccdb22d59cb0.png?e=1556192432&token=vAB0m5fgWj5rV7RWjbzAqEC8NMy8HtT7WmTT19JI:LIK9Kh_jbPglwn4XuYsnY23sT00=";
			course.setPicture(defaultImg); 
		}
	}
